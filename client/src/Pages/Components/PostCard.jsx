...
export default function PostCard({ post }) {
  return (
    <div className='group relative w-full max-[700px]:mx-2 border border-[#85053a] hover:border-2 h-[300px] overflow-hidden rounded-lg sm:w-[400px] md:w-[350px] transition-all'>
