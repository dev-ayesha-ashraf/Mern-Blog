...
export default function DashSideBar() {
    ...
    return (
        <div>
            ...
            {/* Sidebar */}
            <div
                className={`fixed left-0 top-20 mt-1 h-full bg-gray-800 text-white shadow-md transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-[8rem]'} md:translate-x-0`}
            >
